...
(t/deftest jump-game
  (t/testing "[2 3 1 1 4]=>true" (t/is (p/jump-game [2 3 1 1 4])))
  (t/testing "[3 2 1 0]=>true" (t/is (p/jump-game [3 2 1 0])))
  (t/testing "[1]=>true" (t/is (p/jump-game [1])))
  (t/testing "[2 0]=>true" (t/is (p/jump-game [2 0])))
  (t/testing "[2 5 0 0]=>true" (t/is (p/jump-game [2 5 0 0])))
  (t/testing "[3 2 1 0 4]=>false" (t/is (not (p/jump-game [3 2 1 0 4])))))
